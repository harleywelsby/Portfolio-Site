...
export const ABOUT_ME_PARAGRAPH_2 = `I graduated from Victoria University of Wellington in 2023 with a Bachelor of Engineering with Honours in Software Engineering. I started my career as a Software Developer Intern at PartsTrader via the Summer of Tech program in 2021, and I've been working there ever since.`;
export const ABOUT_ME_PARAGRAPH_3 = `I'm currently available for Full-Stack or Front-End Developer Roles. Feel free to reach out to me on LinkedIn at the link below, check out my GitHub portfolio, or stay and scroll to see some of the cool stuff I've done!`;
...
// Skills Section
// All paths are from Simple Icons - https://simpleicons.org/
